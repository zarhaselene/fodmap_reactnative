        ...
        <View className='gap-2'>
          ...
          <View className='flex-row gap-12 border-border border-b mb-4'>
            <TouchableOpacity onPress={() => setActiveTab('ingredients')}>
              <Text
                className={`${
                  activeTab === 'ingredients' ? 'text-brand-primary border-border-brand border-b ' : 'text-text-muted'
            ...
            <TouchableOpacity onPress={() => setActiveTab('instructions')}>
              <Text
                className={`${
                  activeTab === 'instructions' ? 'text-brand-primary border-border-brand border-b ' : 'text-text-muted'
                } text-center pb-4 font-semibold`}
              >
                Instructions
              </Text>
            ...
            <TouchableOpacity onPress={() => setActiveTab('nutrition')}>
              <Text
                className={`${
                  activeTab === 'nutrition' ? 'text-brand-primary border-border-brand border-b ' : 'text-text-muted'
                } text-center pb-4 font-semibold`}
              >
                Nutrition
              </Text>
          ...
          <View className='flex-row flex-wrap gap-2'>
            {recipeTags.map((tag, index) => (
              <View key={index} className='bg-surface-tertiary px-3 py-1 rounded'>
